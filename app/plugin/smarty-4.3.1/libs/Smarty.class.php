 ...
 */
/**
 * set SMARTY_DIR to absolute path to Smarty lib files.
...
/**
 * Load always needed external lib files
 */
...
/**
 * This is the main Smarty lib
 *
 * @package Smarty
 *
 * The following methods will be dynamically loaded by the extension handler when they are called.
 * They are located in a corresponding Smarty_Internal_Method_xxxx lib
 *
...
class Smarty extends Smarty_Internal_TemplateBase
{
    ...
    */
    ...
    /**
     * implementation of security lib
     *
     * @var Smarty_Security
     */
     ...
     * lib name format: Smarty_PluginType_PluginName
     * plugin filename format: plugintype.pluginname.php
     *
     * @param string $plugin_name lib plugin name to load
