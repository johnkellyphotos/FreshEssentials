...
/**
 * This lib does contain the security settings
 */
...
class Smarty_Security
{
     ...
     *         'class_2' => array(),                       // all methods of lib allowed
     *       )
     ...
     *         'class_2' => array(),                   // all properties of lib allowed
     *       )
     * If set to null none is allowed.
     *
     * @var array
    ...
    /**
     * Check if static lib is trusted.
     *
     * @param string $class_name
     * @param object $compiler compiler object
     *
     * @return boolean                 true if lib is trusted
     */
    public function isTrustedStaticClass($class_name, $compiler)
    {
        ...
        $compiler->trigger_template_error("access to static lib '{$class_name}' not allowed by security setting");
        return false; // should not, but who knows what happens to the compiler in the future?
    }

    /**
     * Check if static lib method/property is trusted.
     *
     * @param string $class_name
     * @param string $params
     * @param object $compiler compiler object
     *
     * @return boolean                 true if lib method is trusted
     */
    public function isTrustedStaticClassAccess($class_name, $params, $compiler)
    {
        ...
        $compiler->trigger_template_error("access to static lib '{$class_name}' {$params[2]} '{$name}' not allowed by security setting");
        return false; // should not, but who knows what happens to the compiler in the future?
    }
    ...
    /**
     * Loads security lib and enables security
     *
     * @param \Smarty                $smarty
     * @param string|Smarty_Security $security_class if a string is used, it must be lib-name
     *
     * @return \Smarty current Smarty instance for chaining
     * @throws \SmartyException when an invalid lib name is provided
     */
    public static function enableSecurity(Smarty $smarty, $security_class)
    {
        ...
        if (!class_exists($security_class)) {
            throw new SmartyException("Security lib '$security_class' is not defined");
