 ...
 * This is the config file compiler lib. It calls the lexer and parser to
...
class Smarty_Internal_Config_File_Compiler
{
     ...
     * Initialize compiler
     *
     * @param string $lexer_class  lib name
     * @param string $parser_class lib name
